package de.til7701.javelin;

import de.til7701.javelin.cli.ExceptionExitCodeMapper;
import de.til7701.javelin.cli.ExceptionHandler;
import de.til7701.javelin.cli.commands.Javelin;
...
public class Main {
    ...
    static void main(String[] args) throws Exception {
        CommandLine.Help.ColorScheme colorScheme = new CommandLine.Help.ColorScheme.Builder()
                ...
                .build();
        CommandLine cli = new CommandLine(new Javelin());
